...
<?php endif; ?>
        ...
        <?php if((! $hasTopbar) && filament()->isGlobalSearchEnabled()): ?>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-3823723215-0', $__slots ?? [], get_defined_vars());
...
<?php endif; ?>
        ...
        <?php if((! $hasTopbar) && filament()->auth()->check()): ?>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-3823723215-1', $__slots ?? [], get_defined_vars());
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament-panels::components.user-menu','data' => ['dropdownPlacement' => 'top-end']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['dropdown-placement' => 'top-end']); ?>
...
<?php /**PATH C:\xampp\htdocs\marcella_bakery_and_cake\vendor\filament\filament\resources\views/livewire/sidebar.blade.php ENDPATH**/ ?>